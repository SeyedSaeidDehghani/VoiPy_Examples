...
class Agent:
    ...
    def __init__(self):
        ...
        self.current_call_is_hold: bool = False
    ...
    def call_back_phone(self,
        ...
        if call_state == Call_State.DIALING:
            ...
            hold_call = Timer(interval=10, function=self.hold_call)
            hold_call.name = "hold_call"
            hold_call.start()

        elif call_state == Call_State.HOLD:
            # Current call is hold
            self.current_call_is_hold = True
    ...
    def hold_call(self):
        self.current_call.hold(call_id=self.current_call_id, is_hold=self.current_call_is_hold)

        unhold_call = Timer(interval=10, function=self.unhold_call)
        unhold_call.name = "unhold_call"
        unhold_call.start()
